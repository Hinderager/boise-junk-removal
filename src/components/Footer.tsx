        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services" className="text-white/80 hover:text-white transition-colors">What We Take</Link></li>
              <li><Link href="/resources/pricing" className="text-white/80 hover:text-white transition-colors">Pricing</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-white/80">Mon-Sun: 8am - 9pm</p>
              </li>
            </ul>
          </div>
        </div>
